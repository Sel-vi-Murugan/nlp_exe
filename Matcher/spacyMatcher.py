...
patterns = {
    ...
    # "SBAR": [{"LOWER": "if", "OP": "?"}, {"POS": {"IN": ["ADV", "ADP", "DET", "PRON"]}, "OP": "*"},{"POS": {"IN": ["VERB", "AUX"]}, "OP": "*"}],
    ...
    "CONJ": [{"POS": "CCONJ"}, {"POS": {"IN": ["ADV", "ADP", "DET", "PRON"]}, "OP": "*"},{"POS": {"IN": ["VERB", "NOUN", "ADJ", "PART"]}, "OP": "*"}],
    "ART": [{"POS": "DET"}],
    "NUM": [{"POS": "NUM"}],
    ...
    "C": [{"POS": "CCONJ"}, {"POS": {"IN": ["ADV", "ADP", "DET", "PRON"]}, "OP": "*"},{"POS": {"IN": ["VERB", "NOUN", "ADJ", "PART"]}, "OP": "*"}],
    ...
    "SVNAdvP": [
        {"POS": {"IN": ["PRON", "NOUN", "PROPN"]}},{"POS": {"IN": ["VERB", "AUX"]}},{"ENT_TYPE": {"IN": ["PERSON", "ORG", "GPE"]}, "OP": "+"},  # Noun Phrase (PERSON, ORG, GPE)
        {"POS": "ADV", "OP": "+"},{"POS": "ADP", "OP": "?"},{"ENT_TYPE": {"IN": ["PERSON", "ORG", "GPE"]}, "OP": "+"}],
